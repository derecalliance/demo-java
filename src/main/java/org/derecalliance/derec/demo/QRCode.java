...
public class QRCode {
    ...
    public void createHelperPane(CaptureCallback callback) {
        ...
        captureButton.setStyle("-fx-background-color: limegreen; " + // Bright green background
                "-fx-text-fill: black; "
                + // White font color
                "-fx-opacity: 1.0;");
        ...
        Screen screen = Screen.getScreensForRectangle(MainApp.primaryStage.getX(), MainApp.primaryStage.getY(), 1, 1)
                .get(0);
